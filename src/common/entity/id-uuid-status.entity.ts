// Path: src/common/entity/id-uuid-status.entity.ts
// DESC: id uuid status entity
'use strict';
...
export class IdUuidStatusEntity {
  // @ApiProperty({
  ...
  // })
  @ApiProperty({
    description: 'ID is Unique identifier for ' + IdUuidStatusEntity.name,
    example: 'abc.xyz',
  })
  @Expose({ name: 'ID', toPlainOnly: true })
...
export default IdUuidStatusEntity;
