// Path: src/stakeholders/team/repository/prisma-team.repository..ts
...
// export class PrismaMongoDBTeamRepository implements TeamRepositoryInterface {
//   private readonly logger: Logger = new Logger(PrismaMongoDBTeamRepository.name);
...
// export default PrismaMongoDBTeamRepository;
