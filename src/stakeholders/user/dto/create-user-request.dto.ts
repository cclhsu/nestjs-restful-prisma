// Path: src/stakeholders/user/dto/create-user-request.dto.ts
// DESC: create user request dto
'use strict';
...
export class CreateUserRequestDTO {
  @ApiProperty({
    description: 'ID is Unique identifier for ' + CreateUserRequestDTO.name,
    example: 'john.doe',
  })
